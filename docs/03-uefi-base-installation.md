...
- `compress=no` is used for select high-churn subvolumes (these also happen to be separated out from snapshots of `/`)
...
btrfs subvolume snapshot -r /home /home/.milestone-snapshots/03-base-install
```
