...
_ROOT_PARENT_PATH="$LOCAL_ROOT_SNAP_DIR/$_ROOT_PARENT"

btrfs_send_receive_pipeline "$_ROOT_PARENT_PATH" root
...
_HOME_PARENT_PATH="$LOCAL_HOME_SNAP_DIR/$_HOME_PARENT"

btrfs_send_receive_pipeline "$_HOME_PARENT_PATH" home
